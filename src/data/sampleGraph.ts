...
export const sampleGraph: KnowledgeGraph = {
  ...
  ipaByQuestion: {
    'Given a list of words, count the frequency of each word': [
      { step: 1, type: 'RECOGNIZE', operation: 'Problem requires tracking counts for each unique word' },
      { step: 2, type: 'RECOGNIZE', operation: 'Need to iterate through all words' },
      { step: 3, type: 'RECALL', operation: 'Dictionary is appropriate for word->count mapping' },
      { step: 4, type: 'APPLY', operation: 'Initialize empty dictionary' },
      { step: 5, type: 'APPLY', operation: 'Loop through each word in list' },
      { step: 6, type: 'CHECK', operation: 'Does word already exist as key?' },
      { step: 7, type: 'BRANCH', operation: 'If yes: increment count by 1' },
      { step: 8, type: 'BRANCH', operation: 'If no: insert word with count 1' },
    ],
    'Group a list of students by their grade level': [
      { step: 1, type: 'RECOGNIZE', operation: 'Problem requires grouping items by a key' },
      { step: 2, type: 'RECOGNIZE', operation: 'Need to iterate through all students' },
      { step: 3, type: 'RECALL', operation: 'Dictionary with list values for grouping' },
      { step: 4, type: 'APPLY', operation: 'Initialize empty dictionary' },
      { step: 5, type: 'APPLY', operation: 'Loop through each student' },
      { step: 6, type: 'CHECK', operation: 'Does grade key exist?' },
      { step: 7, type: 'BRANCH', operation: 'If no: create key with empty list' },
      { step: 8, type: 'APPLY', operation: 'Append student to grade list' },
    ],
    'Find all unique elements that appear in both lists': [
      { step: 1, type: 'RECOGNIZE', operation: 'Problem requires finding common unique elements' },
      { step: 2, type: 'RECALL', operation: 'Sets provide uniqueness and intersection' },
      { step: 3, type: 'APPLY', operation: 'Convert first list to set' },
      { step: 4, type: 'APPLY', operation: 'Convert second list to set' },
      { step: 5, type: 'APPLY', operation: 'Compute intersection of both sets' },
    ],
  },
};
